...
button_add = Button(root, text='+', bg = '#F6B4C3', padx=39, pady=20, command=button_add)
...
button_multiplicar = Button(root, text='x', bg = '#C3BAD6', padx=41, pady=20, command=button_multiplicar)
button_dividir = Button(root, text='/', bg='#C9DDD5', padx=40, pady=20, command=button_dividir)
